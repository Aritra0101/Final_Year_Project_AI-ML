...
# from sklearn.preprocessing import MinMaxScaler
# from keras.models import Sequential, Model
# from keras.layers import LSTM, Dense, Dropout, Input, Conv1D, MaxPooling1D, Flatten, Activation, concatenate, multiply, Lambda
# from keras import backend as K
# from keras.callbacks import EarlyStopping
# from keras.optimizers import Adam
...
# # Train the model
# early_stopping = EarlyStopping(monitor='val_loss', patience=10)
# history = model.fit(x_train, y_train, batch_size=64, epochs=100, validation_split=0.2, callbacks=[early_stopping], verbose=1)
...
from keras.layers import LSTM, Dense, Dropout, Input, Conv1D, MaxPooling1D, Flatten, Activation, concatenate, multiply, Permute, Lambda
from keras import backend as K
from keras.callbacks import EarlyStopping
from keras.optimizers import Adam
